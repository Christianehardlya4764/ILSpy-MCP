...
public sealed class ListAssemblyTypesTool
{
    ...
    [Description("Use this when you need a broad inventory of what an unfamiliar binary contains before narrowing scope. Lists all public types grouped by namespace (names only, no signatures). For a single namespace with full signatures and member counts, use list_namespace_types instead.")]
